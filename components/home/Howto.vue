...
const steps = [
    {
        ...
        description: "If you do not have an Arweave wallet yet, create it here and you can connect using arweave.app or arConnect.",
        color: "purple",
    ...
    },
    {
        ...
        description: "Promote your collection and sell your NFTs via the RareWeave market. Earn.",
        color: "red",
